let pokemonRepository = (function () {
 ...
 function showModal({name, imageUrl, height}) {
  ...
  closeButtonElement.classList.add ("btn", "btn-danger", "modal-close");
  closeButtonElement.innerText= "close";
  closeButtonElement.addEventListener ("click",hideModal);

  let titleElement= document.createElement ("h1");
  titleElement.classList.add ("modal-title");//Bootstrap class for modal title
  titleElement.innerText= name;

  let contentElement = document.createElement ("p");
  contentElement.classList.add ("modal-body");//Bootstrap class for modal body
  contentElement.innerText = "Height" + height;

  let imageElement =document.createElement ("img");
  imageElement.classList.add ("modal-img");// Bootstrap class for modal image
...
function addListItem(pokemon) {
  ...
  var listItem = document.createElement('button'); // Change
